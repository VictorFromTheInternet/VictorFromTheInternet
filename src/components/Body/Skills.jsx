        ...
        <>
            <section id="skills" className={styles.skillsBanner}>
                ...
                <div className={styles.skillsContainer}>
                    {/* <img src={getImageUrl('skills/figma.png')} aria-label="Figma" label="Figma" alt="Figma" height="75" width="75" />                    
                    ...
                    {/* figma */}
                    <svg title="Figma" ariaLabel="Figma" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
                    <title>Figma</title>
